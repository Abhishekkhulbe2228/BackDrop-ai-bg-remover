        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-1 md:order-2">
                ...
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                    Transform your photos with our background remover app! Highlight your subject with precision and remove unwanted backgrounds in seconds. Powered by advanced AI technology, Backdrop delivers clean, professional results instantly. Whether for social media, e-commerce, or personal projects, Try it now and create stunning visuals effortlessly with just one click.
                </p>
